...
<div class="row margin-bottom-12">
    <div class="col-md-12">
        <a href="{!! URL::route('admin_pnd_school_test.edit') !!}" class="btn btn-info pull-right">
...
<table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{!! URL::route('admin_pnd_school_test.edit', ['id' => $school->school_id]) !!}"><i class="fa fa-edit fa-2x"></i></a>
                <a href="{!! URL::route('admin_pnd_school_test.delete',['id' =>  $school->school_id, '_token' => csrf_token()]) !!}" class="margin-left-5 delete"><i class="fa fa-trash-o fa-2x"></i></a>
