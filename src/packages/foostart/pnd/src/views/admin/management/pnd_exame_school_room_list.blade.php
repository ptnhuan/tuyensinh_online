...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    @include('pnd::admin.management.pnd_exame_school_room_item')
        ...
        <div class="col-md-4"  >
            ...
            @include('pnd::admin.management.pnd_exame_school_list_search')
          @include('pnd::admin.management.pnd_exame_school_room_list_filter',['name_search'=>'_examine_point'])       
