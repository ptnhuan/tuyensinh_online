...
@section('title')
{!! trans('pnd::pnd.school_title_about') !!}
@stop
@section('content')
<div class="row">
    <div class="col-md-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title bariol-thin">
                        {!! !empty($schools->school_id) ? '<i class="fa fa-pencil"></i>'.trans('pnd::pnd.form_school_about_edit') : '<i class="fa fa-users"></i>'.trans('pnd::pnd.form_school_about_edit') !!}
                    </h3>
                </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            ...
                            {!! Form::open(['route'=>['admin_pnd_option_1_school_about.post', 'id' => @$school->school_id],  'files'=>true, 'method' => 'post'])  !!}
