        ...
        <div class="col-md-8"  >
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title bariol-thin"><i class="fa fa-group"></i> {!! $request->all() ? trans('pnd::pnd.page_school_search') : trans('pnd::pnd.page_school_level2_list') !!}</h3>
                </div>
                ...
                <div class="panel-body"> 
                    @include('pnd::front.pnd_statistics_level_2_item')
                </div>
            </div>
        </div>   
        <div class="col-md-2"></div>
