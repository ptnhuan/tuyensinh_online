...
class PndExaminepointpriorAdminValidator extends AbstractValidator
{   
    protected static $rules = array(
        'school_prior_point_1' => 'required',
        'school_prior_point_2' => 'required',
      'school_prior_point_3' => 'required'       
    );
...
//        $flag = $this->isValidDescription($input)?$flag:FALSE;
    ...
    public function messages() {
        ...
        'school_prior_point_1' => 'Nhập Điểm tối đa UT-KK xét tuyển  ',
        'school_prior_point_2' => 'Điểm tối đa UT-KK thi tuyển điểm',
