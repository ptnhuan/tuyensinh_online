...
<div class="type-413">
    <div class="alert alert-info">
        ...
        <hr class="message-inner-separator">
          <p>Hình thức cập nhật: <b><?php if ($pexcel->pexcel_update==0){ echo "Cập nhật điểm ưu tiên-khuyến khích"; } ?></b> </p>
...
<div class="row margin-bottom-12">
    <div class="col-md-12 margin-bottom-12">
        ...
        <span>
                ...
                <a href="{!! URL::route('admin_update_pexcel.parse',['idupdate' =>  $pexcel->pexcel_id, '_token' => csrf_token()]) !!}"  class="btn btn-info  payroll-delete pexcel-delete">
                <i class="fa fa-times"></i>Xác nhận</a>
        ...
        <span>
            <a href="{!! URL::route('admin_update_pexcel.delete',['id' =>  $pexcel->pexcel_id, '_token' => csrf_token()]) !!}"  class="btn btn-info  payroll-delete pexcel-delete">
