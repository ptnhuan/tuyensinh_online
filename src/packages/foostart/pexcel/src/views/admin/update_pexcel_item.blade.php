...
<?php echo $pexcel->pexcel_file_path ?>
            ...
            <td>
                <div class="item_right">
                    <a href="{!! URL::route('admin_update_pexcel.edit', ['id' => $pexcel->pexcel_id]) !!}"><i class="fa fa-edit fa-2x"></i></a>
                    <a href="{!! URL::route('admin_update_pexcel.delete',['id' =>  $pexcel->pexcel_id, '_token' => csrf_token()]) !!}" class="margin-left-5 delete">
