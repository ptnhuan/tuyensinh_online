                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="login-form">
                                ...
                                <input id="email" class="form-control form-input" required="required" autocomplete="off"
                                       name="email" type="text" value="">
                                <span id="RequiredFieldValidator5" title="User Name is required."
                                      class="failureNotification" style="visibility: hidden;">*</span>
                                <label class="lb ps">
                                    {{trans('tuyensinh.login_pass')}}</label><br>
                                <input id="password" class="form-control form-input" required="required"
                                       autocomplete="off" name="password" type="password" value="">
                                <span id="RequiredFieldValidator6" title="Password is required."
                                      class="failureNotification" style="visibility: hidden;">*</span><br>
                                <br>
                                <div class="rmb">
                                    <input type="submit" name="Login" value="{{trans('tuyensinh.login_login')}}"
                                           class="btnn">
                                </div>
                            </div>
                            </form>
